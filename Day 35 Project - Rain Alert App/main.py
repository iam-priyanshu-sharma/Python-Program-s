...
account_sid = "YOUR ACCOUNT SID"  # Your twilio a/c sid
auth_token = os.environ.get("AUTH_TOKEN")  # Your twilio a/c authorized token

weather_params = {
    "lat": "YOUR LATITUDE",  # Your latitude
    "lon": "YOUR LONGITUDE",  # Your longitude
    "appid": api_key,  # Your API Key from openweather or any other provider
