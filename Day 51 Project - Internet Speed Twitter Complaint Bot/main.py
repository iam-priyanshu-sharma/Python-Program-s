...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        accept_button = self.driver.find_elements(By.XPATH, '//*[@id="onetrust-accept-btn-handler"]')
        accept_button.click()

        time.sleep(3)

        go_button = self.driver.find_elements(By.CSS_SELECTOR, ".start-button a")
        go_button.click()
        time.sleep(60)
        self.up = self.driver.find_elements(By.XPATH,
                                            '//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[3]/div/div['
                                            '3]/div/div/div[2]/div[1]/div[2]/div/div[2]/span').text
        self.down = self.driver.find_elements(By.XPATH,
    ...
    def tweet_at_provider(self):
        ...
        password = self.driver.find_elements(By.XPATH,
                                             '//*[@id="react-root"]/div/div/div[2]/main/div/div/div[1]/form/div/div['
        ...
        time.sleep(5)
        tweet_compose = self.driver.find_elements(By.XPATH,
        ...
        time.sleep(3)
        tweet_button = self.driver.find_elements(By.XPATH,
                                                 '//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div/div/div['
